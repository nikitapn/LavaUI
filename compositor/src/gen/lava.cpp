...
public:
  ...
  auto _1() noexcept { return ::lava::flat::Wallpaper_Direct(buffer_, offset_ + offsetof(lava_M13, _1)); }
};
...
public:
  ...
  auto _1() noexcept { return ::lava::flat::KeyboardSettings_Direct(buffer_, offset_ + offsetof(lava_M14, _1)); }
};
...
public:
  ...
  auto _1_d() noexcept { return ::nprpc::flat::Vector_Direct2<::lava::flat::KeyboardLayout,::lava::flat::KeyboardLayout_Direct>(buffer_, offset_ + offsetof(lava_M15, _1)); }
...
public:
  ...
  auto _1_d() noexcept { return ::nprpc::flat::Vector_Direct2<::lava::flat::KeyBinding,::lava::flat::KeyBinding_Direct>(buffer_, offset_ + offsetof(lava_M16, _1)); }
...
public:
  ...
  auto _1_d() noexcept { return ::nprpc::flat::Vector_Direct2<::lava::flat::OutputInfo,::lava::flat::OutputInfo_Direct>(buffer_, offset_ + offsetof(lava_M17, _1)); }
...
public:
  ...
  auto _1() noexcept { return (::nprpc::flat::Span<char>)base()._1; }
  auto _1() const noexcept { return (::nprpc::flat::Span<const char>)base()._1; }
  auto _1_d() noexcept { return ::nprpc::flat::String_Direct1(buffer_, offset_ + offsetof(lava_M18, _1)); }
};
...
public:
  ...
  auto _1_d() noexcept { return ::nprpc::flat::Vector_Direct2<::lava::flat::OutputMode,::lava::flat::OutputMode_Direct>(buffer_, offset_ + offsetof(lava_M19, _1)); }
...
public:
  ...
  auto _1() noexcept { return ::lava::flat::OutputRequest_Direct(buffer_, offset_ + offsetof(lava_M20, _1)); }
};
...
public:
  ...
  auto _1_d() noexcept { return ::nprpc::flat::Vector_Direct2<::nprpc::flat::String,::nprpc::flat::String_Direct1>(buffer_, offset_ + offsetof(lava_M22, _1)); }
};
...
public:
  ...
  auto _1() noexcept { return ::lava::flat::Capture_Direct(buffer_, offset_ + offsetof(lava_M24, _1)); }
};
...
public:
  ...
  auto _2_d() noexcept { return ::nprpc::flat::String_Direct1(buffer_, offset_ + offsetof(lava_M25, _2)); }
};
...
bool check_1Wallpaper_1(::nprpc::flat_buffer& buf, lava_M13_Direct& ia) {
...
bool check_1KeyboardSettings_1(::nprpc::flat_buffer& buf, lava_M14_Direct& ia) {
...
bool check_1S(::nprpc::flat_buffer& buf, lava_M18_Direct& ia) {
...
bool check_1OutputRequest_1(::nprpc::flat_buffer& buf, lava_M20_Direct& ia) {
...
bool check_1Fu322Ff323Ff32(::nprpc::flat_buffer& buf, lava_M21_Direct& ia) {
  if (static_cast<std::uint32_t>(buf.size()) < ia.offset() + 12) goto check_failed;
  return true;
check_failed:
  return false;
}
bool check_1Fu322Fi323Fi324Fi325Fi326Fi32(::nprpc::flat_buffer& buf, lava_M23_Direct& ia) {
  if (static_cast<std::uint32_t>(buf.size()) < ia.offset() + 24) goto check_failed;
  return true;
check_failed:
  return false;
}
bool check_1Fu322S(::nprpc::flat_buffer& buf, lava_M25_Direct& ia) {
  if (static_cast<std::uint32_t>(buf.size()) < ia.offset() + 12) goto check_failed;
  {
